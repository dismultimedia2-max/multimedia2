...
export default function SummaryScreen({ answers, questions, onEdit, onFinish }: SummaryScreenProps) {
  ...
  return (
    <motion.div
      ...
      className="size-full flex flex-col bg-white overflow-hidden"
    >
      {/* Header */}
      <div className="px-10 pt-8 pb-3 flex-shrink-0">
        ...
        <motion.p
          ...
          className="text-sm"
          style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 400, color: B.muted }}
        >
          Podés modificar cualquier respuesta antes de continuar
        </motion.p>
      </div>

      <div className="px-10 mb-2 flex-shrink-0">
        <div className="h-px" style={{ background: '#ede8e4' }} />
      </div>

      {/* Scrollable answer cards */}
      <div className="flex-1 px-10 overflow-y-auto py-2">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <p
                      ...
                      style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 400, fontSize: '1.5rem', color: '#1c1917' }}
                    >
                      {q.question}
                    </p>
                    {answer ? (
                      <div className="flex items-center gap-2.5">
                        ...
                        <p
                          ...
                          style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 500, fontSize: '0.95rem', color: B.primary }}
                        >
                          {answer.answer}
                        </p>
                      </div>
                    ) : (
                      <p className="text-base italic" style={{ fontFamily: "'Poppins', sans-serif", color: '#d1c8c0' }}>
                        Sin respuesta
                      </p>
                    )}
                  </div>
                  ...
                  >
                    <Edit2 className="w-4 h-4" style={{ color: B.primary }} />
                  </motion.button>
                </div>
              </motion.div>
            );
      ...
      <div
        className="px-10 pb-8 pt-4 flex-shrink-0 flex flex-col items-center gap-2"
        style={{ borderTop: '1px solid #ede8e4' }}
      >
        {!allAnswered && (
          <p className="text-xs text-center" style={{ fontFamily: "'Poppins', sans-serif", color: B.muted }}>
        ...
        <motion.button
          ...
          style={{
            ...
            fontWeight: 500,
            background: allAnswered ? B.primary : '#e5e0db',
            color: allAnswered ? '#ffffff' : B.muted,
